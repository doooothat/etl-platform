...
> **AI Tooling**: This project uses **Claude Code** (Terminal) and **Antigravity** (IDE) in parallel.
> - **Session Handoff (Mandatory Check)** → `./handoff.md` (Read before work, update on finish)
> - Detailed Architecture → `./overview.md`
> - Troubleshooting Patterns → `~/.claude/projects/-Users-smylere-work-etl-platform/memory/MEMORY.md`
> - Infra Operation Workflows → `.agents/workflows/`
